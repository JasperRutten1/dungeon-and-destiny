...
app.get("/guardians", async (_req: Request, res: Response) => {
  res.json(await getGuardians());
  console.log("Sent guardians data");
});

app.post("/guardians", async (req: Request, res: Response) => {
...
app.post("/guardians/items/give", async (req: Request, res: Response) => {
...
app.get("/guardians/items/:guardianId", async (req: Request, res: Response) => {
...
app.post("/guardians/weapons/give", async (req: Request, res: Response) => {
...
app.get("/guardians/weapons/:guardianId", async (req: Request, res: Response) => {
...
app.get("/guardians/weapons/equipped/:guardianId", async (req: Request, res: Response) => {
  const guardianId = Number(req.params.guardianId);

  const equippedWeapons: EquippedWeapons = {
...
// Equip a weapon
app.post("/guardians/weapons/equip", async (req: Request, res: Response) => {
...
// Unequip a weapon
app.post("/guardians/weapons/unequip", async (req: Request, res: Response) => {
...
app.post("/guardians/armour/give", async (req: Request, res: Response) => {
...
app.get("/guardians/armour/:armourId", async (req: Request, res: Response) => {
  const armour = await getGuardianArmourStorage(Number(req.params.armourId));
  res.json(armour);
  console.log("Sending guardian armour storage:");
})

app.get("/guardians/armour/equipped/:guardianId", async (req: Request, res: Response) => {
  const guardianId = Number(req.params.guardianId);
...
app.post("/guardians/armour/equip", async (req: Request, res: Response) => {
  const armour = await equipArmour(req.body.guardianId, req.body.armourId);
  res.json(armour);
  console.log(`equipped armour: ${armour.name}`);
})

app.post("/guardians/armour/unequip", async (req: Request, res: Response) => {
...
app.get("/items/weapons", async (_req: Request, res: Response) => {
  res.json(await getWeapons());
  console.log("Sent weapons data");
});

app.post("/items/weapons", async (req: Request, res: Response) => {
  const weapon = await addWeapon(req.body);
  res.json(weapon);
  console.log("Added new weapon:", weapon);
});

app.post("/items/weapons/edit", async (req: Request, res: Response) => {
...
app.get("/items/armour", async (_req: Request, res: Response) => {
  res.json(await getArmor());
  console.log("Sent armor data");
});

app.post("/items/armour", async (req: Request, res: Response) => {
  const armour = await addArmor(req.body);
  res.json(armour);
  console.log("Added new armor:", armour);
});

app.post("/items/armour/edit", async (req: Request, res: Response) => {
  const armour = await editArmour(req.body);
  res.json(armour);
  console.log("Added new armor:", armour);
});

app.get("/guardians/armour/stats/:guardianId", async (req: Request, res: Response) => {
  const guardianId = Number(req.params.guardianId);
...
app.post("/images/armour/:armourId", armourImages.single("file"), async (req: Request, res: Response) => {
  console.log(req.file);
...
app.post("/guardians/health/add", async (req: Request, res: Response) => {
  addHealth(req.body.guardianId, req.body.health).then(guardian => res.json(guardian)).catch(err => res.status(400).send(err));
});

app.post("/guardians/health/remove", async (req: Request, res: Response) => {
